...
public class AuthorizeController {
    ...
    public Object authorize(
        ...
        try {
            ...
            //3、获取Subject，判断用户是否已经login().
            //如果没有则进行登录，登录失败或相关参数不对或请求为get请求则跳转到登录页面
            ...
            //4、登录成功，生成授权码，然后以授权码为键username为值存入缓存。
            ...
            //6、根据OAuthResponse返回ResponseEntity响应
